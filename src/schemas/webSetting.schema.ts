...
export const createWebSettingSchema = z.object({
  ...
  logo: z.string().url('Format URL logo tidak valid').min(1, 'URL logo wajib diisi'),
  favicon: z.string().url('Format URL favicon tidak valid').min(1, 'URL favicon wajib diisi'),
});
...
export const updateWebSettingSchema = z.object({
  ...
  logo: z.string().url('Format URL logo tidak valid').min(1, 'URL logo wajib diisi').optional(),
  favicon: z.string().url('Format URL favicon tidak valid').min(1, 'URL favicon wajib diisi').optional(),
});
